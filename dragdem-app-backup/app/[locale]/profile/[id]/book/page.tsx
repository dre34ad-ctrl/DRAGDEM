...
export default function BookingPage() {
  ...
  const performer = {
    ...
    taxRegime: "RESICO",
    vatRate: 0.16,
    nationalId: "MX123456789", // This would be ABN, T-Number, etc.
  };
  ...
  const fees = useMemo(() => {
    ...
    return calculateFees({
      ...
      isB2B,
      performerTaxRegime: performer.taxRegime,
  ...
  const handleRegionChange = (regionId: string) => {
    ...
    else if (regionId === 'DE' || regionId === 'FR') setCurrency('EUR');
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border-t border-gray-800 pt-4 mt-4 flex justify-between items-center">
                  ...
                  <span className="text-2xl font-montserrat font-bold text-accent">
                    {CURRENCIES[currency].symbol}{(fees.subtotal + fees.vatAmount + fees.kskLiabilityAmount).toFixed(2)}
                  </span>
                </div>
